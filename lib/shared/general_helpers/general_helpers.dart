...
class GeneralHelper {
  static ProgressDialog showDialogLoading(BuildContext context) {
    ...
    pr.style(
        ...
        progressTextStyle: TextStyle(
            color: kPrimaryColor, fontSize: 10.0, fontWeight: FontWeight.w400),
        messageTextStyle: TextStyle(
            color: kPrimaryColor, fontSize: 19.0, fontWeight: FontWeight.w600));
    return pr;
  }
  ...
  static error(context, statusCode, {errorMessage}) => showDialog(
      context: context,
